...
print(LClone_i(np.random.uniform(1,5,size=1),
               ...
               phiD(np.random.uniform(1,5,size=8)),
                ...
                1))
"""
#print(phiD(np.random.uniform(1,5,size=8))[12] * IDD(np.random.uniform(1,5,size=1), np.random.uniform(1,5,size=1), seller['Td'][12],seller['Ts'][12]))

lambda_d = np.random.uniform(2, 10, size=1) 
lambda_s = np.random.uniform(2, 10, size=1) 
phi_d = phiD(np.random.uniform(2, 10, size=8))
phi_s = phiS(np.random.uniform(2, 10, size=8)) 
delta = np.random.uniform(2, 10, size=1) 
